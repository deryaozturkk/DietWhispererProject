...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  {
    $sql="SELECT * FROM `dieticians` WHERE email='$usermail' AND password='$userpass' ";
    ...
    $uyari= ' Giriş yapılamadı.Lütfen kullanıcı adınızı ve şifrenizi kontrol edin';
        ...
        {
        $_SESSION['id'] = $row['id'];
        header("location:dieticianHome.php");
        exit();
        } 
        else{
     $uyari= ' Giriş yapılamadı.Lütfen kullanıcı adınızı ve şifrenizi kontrol edin';
...
<body style="background-image: url('img/diet whisperer.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center center;width: 100vw;
  height: 100vh;">
